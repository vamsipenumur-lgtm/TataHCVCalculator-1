 ...
 * Mirrors HPT_Revenue_MaX.xlsx (monthly-running input variant):
 *   yearlyKm                   = monthlyKm x 12
 ...
 *
 * Verified (monthly 5,417 km ≈ 65,000 km/yr):
...
object HptLogic {
    ...
    fun calculate(i: Inputs): Result {
        val yearlyKm = i.monthlyKm * 12.0
        val annual = i.additionalPayloadT * (i.loadedRunningPct / 100.0) *
                yearlyKm * i.freightRatePerTonKm
        return Result(yearlyKm, annual, annual * i.totalYears)
    }
}
